    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute px-2 w-full max-w-7xl left-[50%] right-[50%] top-[55%] translate-x-[-50%] text-white z-10">
          <h2 className="py-2 text-slate-50">Amazon Prime Clone</h2>
          <h3 className="text-slate-50">
            ReactJS / Tailwind / Firebase / Redux
          </h3>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-2 py-12 md:grid md:grid-cols-5 gap-2">
        <div className="col-span-4 py-8 mb-5 md:mb-0">
          ...
          <p className="py-4 text-gray-600 text-lg">
            Amazon Prime clone built using cutting-edge technologies such as
            React, Redux, Firebase, Firestore and Tailwind CSS. I have used
            Firebase Authentication for secure user login and Firestore as the
            real-time database, Redux for state management, and Tailwind CSS for
            styling the UI.
          </p>
          <a
            href="https://primeclone-e8b1c.web.app/"
            target="_blank"
          ...
          <a
            href="https://github.com/aryanraj60/Amazon-Prime-Clone"
            target="_blank"
